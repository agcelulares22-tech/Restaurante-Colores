...
function getWhatsAppLink(nombre: string, telefono: string, fecha: string, hora: string, pax: number): string {
  ...
  const message = `¡Hola ${nombre}! 🌟 Te confirmamos tu reserva en *Colores Pizza* para el día *${fecha}* a las *${hora}* para *${pax}* ${pax === 1 ? 'persona' : 'personas'}. ¡Te esperamos para compartir una hermosa experiencia con las mejores pizzas al horno de barro! 🍕🍷`;
