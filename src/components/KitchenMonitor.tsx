...
function KitchenMonitor({
  ...
  const renderCircularTimer = (p: Pedido) => {
    ...
    return (
      <div
        key={p.id_pedido}
        className={`rounded-[20px] border border-white/10 bg-[#16161A]/80 backdrop-blur-md shadow-lg overflow-hidden relative ${sem?.border || ''} border-l-4 transition-all duration-300 hover:border-white/20 ${
      ...
      >
        ...
        <div className={`p-4 flex justify-between items-start ${headerTheme} shadow-sm`}>
          ...
          <div className="text-right flex flex-col items-end shrink-0 gap-1">
            ...
            <div className="flex items-center gap-1.5 text-xs font-mono bg-white/5 border border-white/10 px-2 py-0.5 rounded-full">
        ...
        <div className="p-4 space-y-3">
          <div className="space-y-2">
            {p.items.map((it, idx) => (
              <div
                key={idx}
                className="flex items-center gap-3 py-2.5 border-b border-dashed border-white/5 last:border-0"
              >
                ...
                {(it.precio_unitario ?? 0) > 0 && (
                  <span className="text-xs font-mono font-black text-zinc-300 bg-white/5 px-2 py-0.5 rounded-md border border-white/5 shrink-0">
          ...
          {estado === 'en_cocina' && (
            <div className="pt-2 border-t border-white/10">
              {isActiveInOven ? (
                ...
                <div className="flex items-center gap-2 bg-white/5 border border-white/5 px-3 py-2 rounded-xl text-zinc-400">
          ...
          <div className="grid grid-cols-2 gap-3 mt-2">
            <button className="min-h-10 py-2 px-3 bg-white/5 hover:bg-white/10 text-zinc-300 rounded-xl text-xs font-black flex items-center justify-center gap-1.5 transition-all cursor-pointer border border-white/10 btn-premium">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-5 max-h-[700px] overflow-y-auto pr-1">
            ...
            <div className="space-y-3">
              ...
              {ovenActive.length === 0 ? (
                <div className="h-24 border-2 border-dashed border-white/10 bg-white/5 rounded-[20px] flex flex-col justify-center items-center text-center p-4 shadow-sm">
    ...
    return (
      <div className="space-y-4">
        <div className={`flex justify-between items-center p-4 rounded-t-xl border-b-[3px] glass-card text-zinc-100 shadow-sm ${headerClass}`}>
          ...
          <span className={`text-[11px] font-black font-mono w-6 h-6 rounded-full flex items-center justify-center shadow-sm border ${isEmpty ? 'bg-white/5 text-zinc-400 border-white/10' : 'bg-[#E8B800] text-black border-[#E8B800]'}`}>
            {orders.length}
          </span>
        </div>
        ...
        <div className="space-y-4 max-h-[700px] overflow-y-auto pr-1">
          {isEmpty ? (
            <div className="h-40 border-2 border-dashed border-white/10 bg-white/5 rounded-[20px] flex flex-col justify-center items-center text-center p-4 shadow-sm">
              {(() => {
  ...
  return (
    <div className="space-y-5 bg-[#0F0F11]/60 backdrop-blur-md p-4 rounded-[24px] border border-white/5 shadow-2xl" id="kitchen-monitor-container">
