...
export const INITIAL_USUARIOS: Usuario[] = [
  ...
  { id_usuario: 2, nombre: 'Administrador', apellido: '', username: 'admin@colores.com', password: '', rol: 'administrador' },
  { id_usuario: 3, nombre: 'Mozo', apellido: '', username: 'mozo@colores.com', password: '', rol: 'mozo' },
